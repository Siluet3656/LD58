...
namespace Battle
{
    public class AbilityButton : MonoBehaviour
    {
        ...
        public bool IsArrowExists => _arrow != null;
        
        public void StartAbilityCast()
        {
            if (BattleRuler.Instance.IsFighting == false) return;
            
            if (BattleRuler.Instance.IsCastStarted) return;
            ...
            BattleRuler.Instance.IsCastStarted = true;
        }
        ...
        { 
            ...
            BattleRuler.Instance.IsCastStarted = false;
